...
namespace CMetalsWS.Migrations
{
    ...
    [Migration("20250914031329_ExtendWorkOrderForScheduling")]
    partial class ExtendWorkOrderForScheduling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMetalsWS.Data.WorkOrder", b =>
                {
                    ...
                    b.Property<int?>("ActiveCoilUsageId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CoilDescription")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<int?>("CoilInventoryId")
                        .HasColumnType("int");

                    b.Property<string>("CoilItemId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("CoilLocationAtWOStart")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("CoilMillRef")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<DateTime?>("CoilSnapshotAt")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("CoilWeightAtWOStartLbs")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
            ...
            modelBuilder.Entity("CMetalsWS.Data.WorkOrderCoilUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("EndWeightLbs")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.Property<decimal?>("StartWeightLbs")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
            ...
            modelBuilder.Entity("CMetalsWS.Data.WorkOrder", b =>
                {
                    b.HasOne("CMetalsWS.Data.WorkOrderCoilUsage", "ActiveCoilUsage")
                        .WithMany()
                        .HasForeignKey("ActiveCoilUsageId")
                        .OnDelete(DeleteBehavior.Restrict);
