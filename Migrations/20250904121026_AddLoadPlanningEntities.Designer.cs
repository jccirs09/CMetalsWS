...
namespace CMetalsWS.Migrations
{
    ...
    [Migration("20250904121026_AddLoadPlanningEntities")]
    partial class AddLoadPlanningEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CMetalsWS.Data.Customer", b =>
                {
                    ...
                    b.Property<string>("DefaultDestinationRegion")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("DefaultShippingGroup")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CMetalsWS.Data.LoadItem", b =>
                {
                    ...
                    b.HasOne("CMetalsWS.Data.TransferItem", "TransferItem")
                        .WithMany()
